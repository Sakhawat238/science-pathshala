...
class CompetitonQues extends Component {
  state = {
    answersheet: []
  };
    ...
    return (
      <div className={classes.quesMainDiv}>
        <div style={{textAlign:'center'}}>
          <p style={{color:'darkred'}}><strong>Please do not reload this page or go back to the previous page during exam</strong></p>
        </div>
...
export default withStyles(styles)(CompetitonQues);
